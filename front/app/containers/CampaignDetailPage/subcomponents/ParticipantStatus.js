      ...
      <form>
        ...
        <div className="row justify-content-center align-items-center">
          <div className="col-4 content">
            {intl.formatMessage({ ...messages.numberOfSelectedWinners })}
          </div>
          <div className="col-6 label">
            <Input disabled value={ids.length} className="py-2" />
          </div>
        </div>
        <div className="row justify-content-center align-items-center my-2">
          ...
          <div className="col-6 label">
            ...
            >
              ...
              {ids.find(itm => Number(itm.entry_status) !== 1) && (
                <option value="1">
          ...
          <div className="col-auto ml-auto">
            {participantStatus === 1 ? (
              <Button
                ...
                dataDismiss="modal"
                onClick={() => {
                  onSelectWinner(ids.map(itm => itm.id), campaignId, snsId);
