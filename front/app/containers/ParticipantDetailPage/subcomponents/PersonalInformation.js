...
const PersonalInformation = props => {
  ...
  if (isAddress) {
    ...
    addressInvalid =
      ...
      (isAddressReq && zip_code.value === '') ||
      (zip_code.value && zip_code.value.length > 8) ||
      (isAddressReq && prefecture.value === '') ||
      (isAddressReq && address1.value === '') ||
      (address1.value && address1.value.length > 100) ||
      (isAddressReq && address2.value === '') ||
  ...
  if (isTextBox) {
    textboxInvalid =
      ...
      (textbox.value && textbox.value.length > 120);
          ...
          {isTextBox && (
            <div className="row mb-2">
              ...
              <div className="col-7 pr-4">
                <div
                  className={
                    isConfirmStep ? '' : 'dynamic-textarea-holder pl-2 pr-2'
                  }
                  style={{ background: isConfirmStep ? 'none' : '#F7F7F7' }}
                >
                  <Textarea
                    bgray
                    name="formTextbox"
